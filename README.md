## Forked from https://github.com/rusel1989/react-native-bluetooth-serial
...
## Installation
1. Install package via npm: `npm i -S concent-react-native-bluetooth-serial`
...
## Manual installation
#### iOS
1. `npm i -S concent-react-native-bluetooth-serial`
2. In XCode, in the project navigator, right click `Libraries` ➜ `Add Files to [your project's name]`
3. Go to `node_modules` ➜ `concent-react-native-bluetooth-serial` and add `RCTBluetoothSerial.xcodeproj`
...
1. `git clone https://github.com/shashwat-concent/react-native-bluetooth-serial`
